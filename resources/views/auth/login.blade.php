        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="remember" id="remember" class="h-4 w-4 text-[#2C895D] focus:ring-[#2C895D] border-gray-300 rounded">
            ...
            <p class="mt-8 text-center text-sm text-gray-600">
                Belum punya akun? 
                <a href="{{ route('register') }}" class="font-medium text-[#2C895D] hover:text-[#246DA4] transition-colors">Daftar sekarang</a>
            </p>
        </div>
    </div>
</body>
